...
def test_find_closest_current():
    ...
    for hits, currents, expected in test_cases:
        ...
        assert result == expected, f"Failed for hits={hits}, currents={
            currents}. Expected {expected}, got {result}."
...
def test_inclusion_criteria():
    ...
    for idx, (ch_a_hits, ch_b_hits, ch_c_hits, expected) in enumerate(include_test_cases, 1):
        ...
        assert result == expected, f"Include Test case {
            idx} failed. Expected {expected}, got {result}."

    print("\nExclude Test Cases:")
    for idx, (ch_a_hits, ch_b_hits, ch_c_hits, expected) in enumerate(exclude_test_cases, 1):
        result = inclusion_criteria(ch_a_hits, ch_b_hits, ch_c_hits)
        assert result == expected, f"Exclude Test case {
            idx} failed. Expected {expected}, got {result}."
...
if __name__ == "__main__":
    ...
    sorted_data_folders = [
        "C:\\data\\ICMS101\\27-Oct-2023",
        "C:\\data\\ICMS101\\01-Nov-2023",
        "C:\\data\\ICMS101\\03-Nov-2023",
        "C:\\data\\ICMS101\\16-Nov-2023",
        "C:\\data\\ICMS101\\21-Nov-2023",
        "C:\\data\\ICMS101\\22-Nov-2023",
        "C:\\data\\ICMS101\\29-Nov-2023",
        "C:\\data\\ICMS101\\01-Dec-2023",
        "C:\\data\\ICMS101\\05-Dec-2023",
    ]
